...
CREATE UNIQUE INDEX "laporan_vote_laporanId_userId_key"
ON "laporan_vote"("laporanId", "userId");

CREATE INDEX "laporan_vote_userId_idx"
ON "laporan_vote"("userId");

CREATE UNIQUE INDEX "laporan_rating_laporanId_key"
ON "laporan_rating"("laporanId");

CREATE INDEX "laporan_rating_userId_idx"
ON "laporan_rating"("userId");

CREATE INDEX "laporan_rating_dinasId_idx"
ON "laporan_rating"("dinasId");

CREATE INDEX "laporan_rating_cabangDinasId_idx"
